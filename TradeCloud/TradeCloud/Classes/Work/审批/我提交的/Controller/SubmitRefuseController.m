...
@interface SubmitRefuseController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation SubmitRefuseController
...
- (void)viewDidLoad {
    ...
    //搜索通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onSearchBtn:) name:SubmitRefuseNotification object:nil];
}
