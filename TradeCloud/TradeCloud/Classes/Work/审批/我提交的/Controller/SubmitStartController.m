...
@interface SubmitStartController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation SubmitStartController
...
- (void)viewDidLoad {
    ...
    //搜索通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onSearchBtn:) name:SubmitStartNotification object:nil];
