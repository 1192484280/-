...
@interface SubmitCompleteController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation SubmitCompleteController
...
- (void)viewDidLoad {
    ...
    //搜索通知
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onSearchBtn:) name:SubmitCompleteNotification object:nil];
}
